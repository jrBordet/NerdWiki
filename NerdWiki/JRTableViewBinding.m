...
@interface JRTableViewBinding () <UITableViewDataSource, UITableViewDelegate>
...
@implementation JRTableViewBinding
...
+ (instancetype)bindingHelperForTableView:(UITableView *)tableView
    ...
    return [[JRTableViewBinding alloc] initWithTableView:tableView
                                            sourceSignal:source
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    id<JRReactiveView> cell = [tableView dequeueReusableCellWithIdentifier:self.templateCell.reuseIdentifier];
